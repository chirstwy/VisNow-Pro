 ...
 */
public class GaussianCubeReader extends RegularOutFieldVisualizationModule
{

   protected GUI computeUI = null;
   protected ReaderParams params;
   ...
   public void onActive()
   {
      if (params.getFileName() == null)
         return;
      outField = RegularFieldReader.readGaussianCube(params.getFileName());
      if (outField == null)
         return;
