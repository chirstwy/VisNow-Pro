...
public class GUI extends javax.swing.JPanel
{
   ...
   protected TransformParams params = new TransformParams();
    ...
    */
   public void setParams(TransformParams params)
   {
      this.params = params;
   ...
   private void initComponents()
   {
      ...
      transformPanel.setMinimumSize(new java.awt.Dimension(160, 316));
      transformPanel.setPreferredSize(new java.awt.Dimension(206, 320));
