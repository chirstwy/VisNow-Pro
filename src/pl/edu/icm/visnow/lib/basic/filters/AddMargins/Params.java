...
public class Params extends Parameters
{
   ...
   private Parameter<int[][]> margins;
   private Parameter<int[]> components;
   private Parameter<PaddingType> method;

   @SuppressWarnings("unchecked")
   private void initParameters()
   {
      margins = getParameter("margins");
      margins.setValue(new int[][] {{1, 1}, {1, 1}, {1, 1}});
      components = getParameter("components");
      components.setValue(new int[] {0});
      method = getParameter("method");
      method.setValue(PaddingType.ZERO);

   }
   private static ParameterEgg[] eggs = new ParameterEgg[]
   {
      new ParameterEgg<int[][]>("margins", ParameterType.independent),
      new ParameterEgg<int[]>("components", ParameterType.dependent),
   ...
   public PaddingType getMethod()
   {
      return method.getValue();
   }

   public void setMethod(PaddingType method)
   {
